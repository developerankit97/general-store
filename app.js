...
function getItems() {
    axios
        .get('https://crudcrud.com/api/d99f1237d08c414488706fb2c02c89e0/items')
        .then(response => {
...
function addItem(e) {
    ...
    if (name && description && price && quantity) {
        axios
            .post('https://crudcrud.com/api/d99f1237d08c414488706fb2c02c89e0/items', item)
            .then(res => {
...
function buyOne(e) {
    if (e.target.classList.contains('buy1')) {
        ...
        axios
            .put(`https://crudcrud.com/api/d99f1237d08c414488706fb2c02c89e0/items/${id}`, updatedItem)
            .then(response => {
